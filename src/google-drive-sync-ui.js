// Mission Learning OS — Cloud & Sync UI v1.0
(() => {
  ...
  function render(){
    ...
    const nav=document.querySelector('.nav');if(nav&&!nav.querySelector('[data-page="cloud-sync"]')){const b=document.createElement('button');b.dataset.page='cloud-sync';b.innerHTML='☁ <span>Cloud & Sync</span>';nav.appendChild(b)}
