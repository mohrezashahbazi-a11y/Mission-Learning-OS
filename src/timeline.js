// Mission Learning OS — Timeline Engine v0.1
// Confirmed planning horizons: execution starts 25 Mordad 1405; application readiness Sep 2027; deepening through Aug 2028.
(() => {
  const MORDAD_START = new Date('2026-08-16T00:00:00');
  const APPLICATION_TARGET = new Date('2027-09-01T00:00:00');
  const DEEPENING_HORIZON = new Date('2028-08-01T00:00:00');
